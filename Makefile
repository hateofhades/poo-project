...
build:
	...
	g++ -o main main.o QuestionPopup.o Button.o Maze.o QuestionMultipleAnswers.o QuestionCards.o QuestionWordSearch.o QuestionCards2.o -lsfml-graphics -lsfml-window -lsfml-system
