...
class QuestionCards : public sf::Drawable
{
private:
...
public:
    QuestionCards(string question, int correctAnswer, sf::Font font, sf::Sprite image, string answer1, string answer2, string answer3);
    string getQuestion();
