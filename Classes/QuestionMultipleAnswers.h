...
class QuestionMultipleAnswers : public sf::Drawable
{
private:
...
public:
    QuestionMultipleAnswers(string question, int correctAnswer, sf::Font font, string answer1, string answer2, string answer3);
    string getQuestion();
